package com.medialink.deco35mediaplayer
...
class MediaService : Service(), MediaPlayerCallback {
    ...
    companion object {
        const val ACTION_CREATE = "com.medialink.deco35mediaplayer.create"
        const val ACTION_DESTROY = "com.medialink.deco35mediaplayer.destroy"
        const val PLAY = 0
        const val STOP = 1
    }
    ...
    private fun init() {
        ...
        val afd = applicationContext.resources.openRawResourceFd(R.raw.pelangi)
        try {
